...
public class ConexaoMysql {
    ...
    public ConexaoMysql() {
    	// String de conexao
    	this.url = "jdbc:mysql://localhost:3306/projetofinalweb2?useSSL=false&allowPublicKeyRetrieval=true&useTimezone=true&serverTimezone=UTC";
        this.usuario = "root";   // Informe o usuario e senha
        this.senha = "root"; // do seu banco de dados
